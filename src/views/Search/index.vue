...
export default {
  ...
  methods: {
    ...
    //CategoryName面包蟹数据删除 + 更新路由 + 重新请求数据
    removeCategoryName(){
    ...
    //keyword面包蟹数据删除 + 更新路由 + 重新请求数据 + 全局事件总线 传递数据
    removeKeyword(){
    ...
    searchForTrademark(trademark){
      let Trademark = `${trademark.tmId}:${trademark.tmName}`
      this.searchParams.trademark = Trademark
      this.getGoodsListInfo()
    },
    //Trademark面包蟹数据删除 + 重新请求数据
    removeTrademark(){
      delete this.searchParams.trademark
      this.getGoodsListInfo();
    },
    //自定义事件，拼接判断参数传递+ 重新请求数据
